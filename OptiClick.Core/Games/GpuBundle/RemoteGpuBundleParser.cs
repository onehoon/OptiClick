...
public sealed class RemoteGpuBundleParser : IRemoteGpuBundleParser
{
        ...
        Fsr4ManifestPolicy? fsr4Policy = null)
    {
        ...
        using (document)
        {
            ...
            var resolvedFsr4Policy = fsr4Policy ?? Fsr4ManifestPolicy.Disabled;
    ...
    private static JsonElement ResolveGamesSection(JsonElement root, string selectedGpuGroup, out string errorCode)
    {
        ...
        foreach (var property in groups.EnumerateObject())
        {
            ...
            if (groupGames.ValueKind != JsonValueKind.Array)
            {
                errorCode = "invalid_games_section";
                return default;
            }
        ...
        Fsr4ManifestPolicy fsr4Policy)
    {
        ...
        {
            TryAddGameRow(map, row, null, vendor, bundleKey, gpuGroup, manifestVersion, fsr4Policy);
        }
