...
public static class CoreInstallComponentReasonCodes
{
    ...
    public const string UalNotRequested = "ual_not_requested";
    public const string Unreal5NotRequested = "unreal5_not_requested";
    public const string ExtraBundleNotRequested = "extra_bundle_not_requested";
    public const string Fsr4SkippedByGpuPolicy = "fsr4_skipped_by_gpu_policy";
    public const string RtssNotRequested = "rtss_not_requested";
}
