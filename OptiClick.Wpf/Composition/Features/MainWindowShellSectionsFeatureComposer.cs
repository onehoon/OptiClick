...
internal static class MainWindowShellSectionsFeatureComposer
{
    public static MainShellSectionsResolvedDependencies Compose(
        AppSharedServices app,
        MainShellResolvedDependencies shell,
        MainWindowStartupCompositionServices startupComposition)
    {
        return new MainShellSectionsResolvedDependencies
        {
