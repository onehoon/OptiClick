...
internal static class MainWindowUpdateFeatureComposer
{
    public static MainUpdateResolvedDependencies Compose(UpdateCompositionServices update)
    {
        return new MainUpdateResolvedDependencies
        {
            AppUpdateFlowController = update.AppUpdateFlowController,
            AppUpdateCoordinator = new AppUpdateCoordinator(update.AppUpdateFlowController)
        };
    }
}
