...
internal static class MainWindowSupportFeatureComposer
{
    public static MainSupportResolvedDependencies Compose(SupportCompositionServices support)
    {
        return new MainSupportResolvedDependencies
        {
